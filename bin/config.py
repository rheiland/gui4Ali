...
#                         ], layout=tab_layout)  # output_dir, toggle_2D_seed_
    ...
    def fill_xml(self, xml_root):
        ...
        xml_root.find(".//SVG//enable").text = str(self.toggle_svg.value)
        xml_root.find(".//SVG//interval").text = str(self.svg_interval.value)
        xml_root.find(".//full_data//enable").text = str(self.toggle_mcds.value)
#        print('fill_xml: setting fulldata//enable=',str(self.toggle_mcds.value))
        xml_root.find(".//full_data//interval").text = str(self.mcds_interval.value)
